...
public class Checkbox extends Question {
    ...
    public int getAnswers() {
        ...
        System.out.println("For this question, there are multiple answers. To begin answering, enter 'y'.");
        ...
        while (goingToContinue.indexOf('y') >= 0 && userAnswers.size() <= possibleAnswers.size()) {
            ...
            System.out.println("For this question, there are multiple answers. To continue answering, enter" +
                    "'y'. To stop, enter 'n'.");
