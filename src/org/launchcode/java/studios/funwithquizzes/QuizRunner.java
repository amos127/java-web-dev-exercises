...
public class QuizRunner {
    ...
    public static void main(String[] args) {
        ...
        Checkbox newQuestion1 = new Checkbox("Who is the best cat in the world?",
                2, possAns1, correctAns1);
        myQuiz.addQuestion(newQuestion1);

        ArrayList<String> possAns2 = new ArrayList<>(Arrays.asList("Doc", "Tillie", "Gizmo", "Benji", "Nala"));
        MultipleChoice newQuestion2 = new MultipleChoice("Who won the Halloween Costume Contest?",
                1, possAns2, 3);
        myQuiz.addQuestion(newQuestion2);
        TrueFalse newQuestion3 = new TrueFalse("Arr all dogs the best?", 1, true);
